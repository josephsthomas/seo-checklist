...
const WHY_IT_MATTERS = {
  ...
  'CS-04': 'Content organized into clearly labeled sections helps AI models identify and extract the most relevant portion of your page for citations.',
  ...
  'CS-07': 'Short paragraphs are easier for AI models to parse into discrete facts. Long paragraphs dilute topic focus and reduce citation probability.',
  ...
  'CS-09': 'A logical reading order established by semantic landmarks (main, nav, header) helps AI models navigate and extract your content correctly.',
  'CS-10': 'Duplicate content blocks confuse AI models about which version to cite and dilute the authority of your page.',
